...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React8 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState4 = React8.useState, useEffect6 = React8.useEffect, useLayoutEffect = React8.useLayoutEffect, useDebugValue2 = React8.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React8 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = shim.useSyncExternalStore, useRef6 = React8.useRef, useEffect6 = React8.useEffect, useMemo3 = React8.useMemo, useDebugValue2 = React8.useDebugValue;
...
function zoom_default2() {
  var filter2 = defaultFilter2, extent = defaultExtent, constrain = defaultConstrain, wheelDelta3 = defaultWheelDelta, touchable = defaultTouchable2, scaleExtent = [0, Infinity], translateExtent = [[-Infinity, -Infinity], [Infinity, Infinity]], duration = 250, interpolate = zoom_default, listeners = dispatch_default("start", "zoom", "end"), touchstarting, touchfirst, touchending, touchDelay = 500, wheelDelay = 150, clickDistance2 = 0, tapDistance = 10;
  ...
  function wheeled(event, ...args) {
    ...
    var g = gesture(this, args).event(event), t = this.__zoom, k = Math.max(scaleExtent[0], Math.min(scaleExtent[1], t.k * Math.pow(2, wheelDelta3.apply(this, arguments)))), p = pointer_default(event);
    if (g.wheel) {
  ...
  zoom.wheelDelta = function(_) {
    return arguments.length ? (wheelDelta3 = typeof _ === "function" ? _ : constant_default4(+_), zoom) : wheelDelta3;
  };
...
function Panel({ position, children: children2, className, style: style3, ...rest }) {
  const pointerEvents = useStore(selector$g);
  const positionClasses = `${position}`.split("-");
  return import_react2.default.createElement("div", { className: cc(["react-flow__panel", className, ...positionClasses]), style: { ...style3, pointerEvents }, ...rest }, children2);
}
...
var BaseEdge = ({ id: id2, path, labelX, labelY, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style: style3, markerEnd, markerStart, interactionWidth = 20 }) => {
  return import_react2.default.createElement(
    import_react2.default.Fragment,
    null,
    import_react2.default.createElement("path", { id: id2, style: style3, d: path, fill: "none", className: "react-flow__edge-path", markerEnd, markerStart }),
...
var SimpleBezierEdge = (0, import_react2.memo)(({ sourceX, sourceY, targetX, targetY, sourcePosition = Position.Bottom, targetPosition = Position.Top, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style: style3, markerEnd, markerStart, interactionWidth }) => {
  ...
  return import_react2.default.createElement(BaseEdge, { path, labelX, labelY, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style: style3, markerEnd, markerStart, interactionWidth });
});
...
var SmoothStepEdge = (0, import_react2.memo)(({ sourceX, sourceY, targetX, targetY, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style: style3, sourcePosition = Position.Bottom, targetPosition = Position.Top, markerEnd, markerStart, pathOptions, interactionWidth }) => {
...
var StraightEdge = (0, import_react2.memo)(({ sourceX, sourceY, targetX, targetY, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style: style3, markerEnd, markerStart, interactionWidth }) => {
...
var BezierEdge = (0, import_react2.memo)(({ sourceX, sourceY, targetX, targetY, sourcePosition = Position.Bottom, targetPosition = Position.Top, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style: style3, markerEnd, markerStart, pathOptions, interactionWidth }) => {
...
var wrapEdge = (EdgeComponent) => {
  const EdgeWrapper = ({ id: id2, className, type, data, onClick, onEdgeDoubleClick, selected, animated, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style: style3, source, target, sourceX, sourceY, targetX, targetY, sourcePosition, targetPosition, elementsSelectable, hidden, sourceHandleId, targetHandleId, onContextMenu, onMouseEnter, onMouseMove, onMouseLeave, edgeUpdaterRadius, onEdgeUpdate, onEdgeUpdateStart, onEdgeUpdateEnd, markerEnd, markerStart, rfId, ariaLabel, isFocusable, isUpdatable, pathOptions, interactionWidth }) => {
    const edgeRef = (0, import_react2.useRef)(null);
...
var ConnectionLine = ({ nodeId, handleType, style: style3, type = ConnectionLineType.Bezier, CustomComponent, connectionStatus }) => {
  ...
  if (CustomComponent) {
    return import_react2.default.createElement(CustomComponent, { connectionLineType: type, connectionLineStyle: style3, fromNode, fromHandle, fromX, fromY, toX, toY, fromPosition, toPosition, connectionStatus });
  }
  let dAttr = "";
  const pathParams = {
    sourceX: fromX,
  ...
  return import_react2.default.createElement("path", { d: dAttr, fill: "none", className: "react-flow__connection-path", style: style3 });
};
...
function ConnectionLineWrapper({ containerStyle: containerStyle3, style: style3, type, component }) {
  ...
  return import_react2.default.createElement(
    ...
    import_react2.default.createElement(
      ...
      import_react2.default.createElement(ConnectionLine, { nodeId, handleType, style: style3, type, CustomComponent: component, connectionStatus })
    )
  );
}
...
function createUseItemsState(applyChanges3) {
  return (initialItems) => {
    ...
    const onItemsChange = (0, import_react2.useCallback)((changes) => setItems((items2) => applyChanges3(changes, items2)), []);
...
var MiniMapNode = ({ id: id2, x, y, width, height, style: style3, color: color2, strokeColor, strokeWidth, className, borderRadius, shapeRendering, onClick, selected }) => {
...
var Controls = ({ style: style3, showZoom = true, showFitView = true, showInteractive = true, fitViewOptions, onZoomIn, onZoomOut, onFitView, onInteractiveChange, className, children: children2, position = "bottom-left" }) => {
  const store = useStoreApi();
...
// node_modules/@reactflow/node-toolbar/node_modules/@reactflow/core/dist/esm/index.mjs
...
function Panel2({ position, children: children2, className, style: style3, ...rest }) {
  const pointerEvents = useStore2(selector$g2);
  const positionClasses = `${position}`.split("-");
  return import_react6.default.createElement("div", { className: cc(["react-flow__panel", className, ...positionClasses]), style: { ...style3, pointerEvents }, ...rest }, children2);
}
...
var EdgeText2 = ({ x, y, label, labelStyle = {}, labelShowBg = true, labelBgStyle = {}, labelBgPadding = [2, 4], labelBgBorderRadius = 2, children: children2, className, ...rest }) => {
...
var BaseEdge2 = ({ id: id2, path, labelX, labelY, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style: style3, markerEnd, markerStart, interactionWidth = 20 }) => {
  return import_react6.default.createElement(
    import_react6.default.Fragment,
    null,
    import_react6.default.createElement("path", { id: id2, style: style3, d: path, fill: "none", className: "react-flow__edge-path", markerEnd, markerStart }),
...
function getMouseHandler$12(id2, getState, handler) {
  return handler === void 0 ? handler : (event) => {
    const edge = getState().edges.find((e) => e.id === id2);
    if (edge) {
      handler(event, { ...edge });
...
var getD3Transition2 = (selection2, duration = 0) => {
  return selection2.transition().duration(duration);
};
...
function handlePointerDown2({ event, handleId, nodeId, onConnect, isTarget, getState, setState, isValidConnection, edgeUpdaterType, onEdgeUpdateEnd }) {
  ...
  function onPointerMove(event2) {
    ...
    const { handle, validHandleResult } = getClosestHandle2(event2, doc, pointToRendererPoint2(connectionPosition, transform2, false, [1, 1]), connectionRadius, handleLookup, (handle2) => isValidHandle2(handle2, connectionMode, nodeId, handleId, isTarget ? "target" : "source", isValidConnection, doc));
    closestHandle = handle;
    if (!autoPanStarted) {
      autoPan();
      autoPanStarted = true;
...
var Handle2 = (0, import_react6.forwardRef)(({ type = "source", position = Position2.Top, isValidConnection, isConnectable = true, isConnectableStart = true, isConnectableEnd = true, id: id2, onConnect, children: children2, className, onMouseDown, onTouchStart, ...rest }, ref) => {
  var _a, _b;
  const handleId = id2 || null;
  const isTarget = type === "target";
...
function createNodeInternals2(nodes, nodeInternals, nodeOrigin, elevateNodesOnSelect) {
  ...
  nodes.forEach((node) => {
    ...
    Object.defineProperty(internals, internalsSymbol2, {
      enumerable: false,
      value: {
        handleBounds: resetHandleBounds ? void 0 : (_a = currInternals == null ? void 0 : currInternals[internalsSymbol2]) == null ? void 0 : _a.handleBounds,
        z
      }
    });
    nextNodeInternals.set(node.id, internals);
...
function fitView2(get3, options = {}) {
  const { getNodes, width, height, minZoom, maxZoom, d3Zoom, d3Selection, fitViewOnInitDone, fitViewOnInit, nodeOrigin } = get3();
  const isInitialFitView = options.initial && !fitViewOnInitDone && fitViewOnInit;
  const d3initialized = d3Zoom && d3Selection;
  if (d3initialized && (isInitialFitView || !options.initial)) {
...
function updateNodesAndEdgesSelections2({ changedNodes, changedEdges, get: get3, set: set3 }) {
  const { nodeInternals, edges, onNodesChange, onEdgesChange, hasDefaultNodes, hasDefaultEdges } = get3();
  if (changedNodes == null ? void 0 : changedNodes.length) {
    if (hasDefaultNodes) {
      set3({ nodeInternals: handleControlledNodeSelectionChange2(changedNodes, nodeInternals) });
    }
    onNodesChange == null ? void 0 : onNodesChange(changedNodes);
  }
  if (changedEdges == null ? void 0 : changedEdges.length) {
    if (hasDefaultEdges) {
      set3({ edges: handleControlledEdgeSelectionChange2(changedEdges, edges) });
    }
    onEdgesChange == null ? void 0 : onEdgesChange(changedEdges);
  }
}
    ...
    if (d3Selection && d3Zoom) {
      return {
        ...
        setCenter: (x, y, options) => {
          ...
          const centerY = height / 2 - y * nextZoom;
          const transform2 = identity3.translate(centerX, centerY).scale(nextZoom);
          d3Zoom.transform(getD3Transition2(d3Selection, options == null ? void 0 : options.duration), transform2);
        },
        fitBounds: (bounds, options) => {
          const { width, height, minZoom, maxZoom } = store.getState();
        ...
        project: (position) => {
          const { transform: transform2, snapToGrid, snapGrid } = store.getState();
          console.warn("[DEPRECATED] `project` is deprecated. Instead use `screenToFlowPosition`. There is no need to subtract the react flow bounds anymore! https://reactflow.dev/api-reference/types/react-flow-instance#screen-to-flow-position");
          return pointToRendererPoint2(position, transform2, snapToGrid, snapGrid);
        },
        screenToFlowPosition: (position) => {
          const { transform: transform2, snapToGrid, snapGrid, domNode } = store.getState();
          if (!domNode) {
          ...
          return pointToRendererPoint2(relativePosition, transform2, snapToGrid, snapGrid);
        },
        flowToScreenPosition: (position) => {
          const { transform: transform2, domNode } = store.getState();
          if (!domNode) {
          ...
          const { x: domX, y: domY } = domNode.getBoundingClientRect();
          const rendererPosition = rendererPointToPoint2(position, transform2);
          return {
            x: rendererPosition.x + domX,
            y: rendererPosition.y + domY
          };
...
function useReactFlow2() {
  ...
  const getNode = (0, import_react6.useCallback)((id2) => {
    return store.getState().nodeInternals.get(id2);
  }, []);
  ...
  const getEdge = (0, import_react6.useCallback)((id2) => {
    const { edges = [] } = store.getState();
    return edges.find((e) => e.id === id2);
  }, []);
...
var ZoomPane2 = ({ onMove, onMoveStart, onMoveEnd, onPaneContextMenu, zoomOnScroll = true, zoomOnPinch = true, panOnScroll = false, panOnScrollSpeed = 0.5, panOnScrollMode = PanOnScrollMode2.Free, zoomOnDoubleClick = true, elementsSelectable, panOnDrag = true, defaultViewport, translateExtent, minZoom, maxZoom, zoomActivationKeyCode, preventScrolling = true, children: children2, noWheelClassName, noPanClassName }) => {
  ...
  (0, import_react6.useEffect)(() => {
    if (zoomPane.current) {
      ...
      const d3ZoomInstance = zoom_default2().scaleExtent([minZoom, maxZoom]).translateExtent(translateExtent);
      const selection2 = select_default2(zoomPane.current).call(d3ZoomInstance);
      const updatedTransform = identity3.translate(defaultViewport.x, defaultViewport.y).scale(clamp2(defaultViewport.zoom, minZoom, maxZoom));
      const extent = [
        [0, 0],
        [bbox.width, bbox.height]
      ];
  ...
  return import_react6.default.createElement("div", { className: "react-flow__renderer", ref: zoomPane, style: containerStyle2 }, children2);
};
var selector$92 = (s) => ({
  userSelectionActive: s.userSelectionActive,
  userSelectionRect: s.userSelectionRect
...
var createSelectionChange2 = (id2, selected) => ({
  id: id2,
  type: "select",
  selected
});
...
var Pane2 = (0, import_react6.memo)(({ isSelecting, selectionMode = SelectionMode2.Full, panOnDrag, onSelectionStart, onSelectionEnd, onPaneClick, onPaneContextMenu, onPaneScroll, onPaneMouseEnter, onPaneMouseMove, onPaneMouseLeave, children: children2 }) => {
  ...
  const onMouseMove = (event) => {
    ...
    const nodes = getNodes();
    const selectedNodes = getNodesInside2(nodeInternals, nextUserSelectRect, transform2, selectionMode === SelectionMode2.Partial, true, nodeOrigin);
...
function handleNodeClick2({ id: id2, store, unselect = false, nodeRef }) {
  const { addSelectedNodes, unselectNodesAndEdges, multiSelectionActive, nodeInternals, onError } = store.getState();
  const node = nodeInternals.get(id2);
  if (!node) {
    onError == null ? void 0 : onError("012", errorMessages2["error012"](id2));
    return;
  }
  store.setState({ nodesSelectionActive: false });
  if (!node.selected) {
...
var wrapNode2 = (NodeComponent) => {
  const NodeWrapper = ({ id: id2, type, data, xPos, yPos, xPosOrigin, yPosOrigin, selected, onClick, onMouseEnter, onMouseMove, onMouseLeave, onContextMenu, onDoubleClick, style: style3, className, isDraggable, isSelectable, isConnectable, isFocusable, selectNodesOnDrag, sourcePosition, targetPosition, hidden, resizeObserver, dragHandle, zIndex, isParent, noDragClassName, noPanClassName, initialized, disableKeyboardA11y, ariaLabel, rfId, hasHandleBounds }) => {
    ...
    const onMouseEnterHandler = getMouseHandler2(id2, store.getState, onMouseEnter);
    const onMouseMoveHandler = getMouseHandler2(id2, store.getState, onMouseMove);
    const onMouseLeaveHandler = getMouseHandler2(id2, store.getState, onMouseLeave);
    const onContextMenuHandler = getMouseHandler2(id2, store.getState, onContextMenu);
    const onDoubleClickHandler = getMouseHandler2(id2, store.getState, onDoubleClick);
    const onSelectNodeHandler = (event) => {
      const { nodeDragThreshold } = store.getState();
      if (isSelectable && (!selectNodesOnDrag || !isDraggable || nodeDragThreshold > 0)) {
        handleNodeClick2({
    ...
    return import_react6.default.createElement(
      ...
      import_react6.default.createElement(
        Provider2,
        { value: id2 },
        import_react6.default.createElement(NodeComponent, { id: id2, data, type, xPos, yPos, selected, isConnectable, sourcePosition, targetPosition, dragging, dragHandle, zIndex })
      )
    );
  };
  NodeWrapper.displayName = "NodeWrapper";
...
var FlowRenderer2 = ({ children: children2, onPaneClick, onPaneMouseEnter, onPaneMouseMove, onPaneMouseLeave, onPaneContextMenu, onPaneScroll, deleteKeyCode, onMove, onMoveStart, onMoveEnd, selectionKeyCode, selectionOnDrag, selectionMode, onSelectionStart, onSelectionEnd, multiSelectionKeyCode, panActivationKeyCode, zoomActivationKeyCode, elementsSelectable, zoomOnScroll, zoomOnPinch, panOnScroll: _panOnScroll, panOnScrollSpeed, panOnScrollMode, zoomOnDoubleClick, panOnDrag: _panOnDrag, defaultViewport, translateExtent, minZoom, maxZoom, preventScrolling, onSelectionContextMenu, noWheelClassName, noPanClassName, disableKeyboardA11y }) => {
...
var wrapEdge2 = (EdgeComponent) => {
  const EdgeWrapper = ({ id: id2, className, type, data, onClick, onEdgeDoubleClick, selected, animated, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style: style3, source, target, sourceX, sourceY, targetX, targetY, sourcePosition, targetPosition, elementsSelectable, hidden, sourceHandleId, targetHandleId, onContextMenu, onMouseEnter, onMouseMove, onMouseLeave, edgeUpdaterRadius, onEdgeUpdate, onEdgeUpdateStart, onEdgeUpdateEnd, markerEnd, markerStart, rfId, ariaLabel, isFocusable, isUpdatable, pathOptions, interactionWidth }) => {
    ...
    const onEdgeDoubleClickHandler = getMouseHandler$12(id2, store.getState, onEdgeDoubleClick);
    const onEdgeContextMenu = getMouseHandler$12(id2, store.getState, onContextMenu);
    const onEdgeMouseEnter = getMouseHandler$12(id2, store.getState, onMouseEnter);
    const onEdgeMouseMove = getMouseHandler$12(id2, store.getState, onMouseMove);
    const onEdgeMouseLeave = getMouseHandler$12(id2, store.getState, onMouseLeave);
    const handleEdgeUpdater = (event, isSourceHandle) => {
      if (event.button !== 0) {
        return;
      }
...
function isEdgeVisible2({ sourcePos, targetPos, sourceWidth, sourceHeight, targetWidth, targetHeight, width, height, transform: transform2 }) {
  const edgeBox = {
    x: Math.min(sourcePos.x, targetPos.x),
    y: Math.min(sourcePos.y, targetPos.y),
    x2: Math.max(sourcePos.x + sourceWidth, targetPos.x + targetWidth),
...
var ArrowSymbol2 = ({ color: color2 = "none", strokeWidth = 1 }) => {
  return import_react6.default.createElement("polyline", { style: {
    stroke: color2,
    strokeWidth
  }, strokeLinecap: "round", strokeLinejoin: "round", fill: "none", points: "-5,-4 0,0 -5,4" });
};
var ArrowClosedSymbol2 = ({ color: color2 = "none", strokeWidth = 1 }) => {
  return import_react6.default.createElement("polyline", { style: {
    stroke: color2,
    fill: color2,
    strokeWidth
...
var Marker2 = ({ id: id2, type, color: color2, width = 12.5, height = 12.5, markerUnits = "strokeWidth", strokeWidth, orient = "auto-start-reverse" }) => {
  ...
  return import_react6.default.createElement(
    "marker",
    { className: "react-flow__arrowhead", id: id2, markerWidth: `${width}`, markerHeight: `${height}`, viewBox: "-10 -10 20 20", markerUnits, orient, refX: "0", refY: "0" },
    import_react6.default.createElement(Symbol2, { color: color2, strokeWidth })
  );
};
...
var EdgeRenderer2 = ({ defaultMarkerColor, onlyRenderVisibleElements, elevateEdgesOnSelect, rfId, edgeTypes, noPanClassName, onEdgeUpdate, onEdgeContextMenu, onEdgeMouseEnter, onEdgeMouseMove, onEdgeMouseLeave, onEdgeClick, edgeUpdaterRadius, onEdgeDoubleClick, onEdgeUpdateStart, onEdgeUpdateEnd, children: children2 }) => {
...
function Viewport2({ children: children2 }) {
  const transform2 = useStore2(selector$32);
  return import_react6.default.createElement("div", { className: "react-flow__viewport react-flow__container", style: { transform: transform2 } }, children2);
}
...
var createRFStore2 = () => createWithEqualityFn((set3, get3) => ({
  ...initialState2,
  setNodes: (nodes) => {
    const { nodeInternals, nodeOrigin, elevateNodesOnSelect } = get3();
    set3({ nodeInternals: createNodeInternals2(nodes, nodeInternals, nodeOrigin, elevateNodesOnSelect) });
  },
  getNodes: () => {
    return Array.from(get3().nodeInternals.values());
  },
  ...
  setDefaultNodesAndEdges: (nodes, edges) => {
    const hasDefaultNodes = typeof nodes !== "undefined";
    const hasDefaultEdges = typeof edges !== "undefined";
    const nodeInternals = hasDefaultNodes ? createNodeInternals2(nodes, /* @__PURE__ */ new Map(), get3().nodeOrigin, get3().elevateNodesOnSelect) : /* @__PURE__ */ new Map();
    const nextEdges = hasDefaultEdges ? edges : [];
    set3({ nodeInternals, edges: nextEdges, hasDefaultNodes, hasDefaultEdges });
  },
  updateNodeDimensions: (updates) => {
    ...
    const nextFitViewOnInitDone = fitViewOnInitDone || fitViewOnInit && !fitViewOnInitDone && fitView2(get3, { initial: true, ...fitViewOnInitOptions });
    set3({ nodeInternals: new Map(nodeInternals), fitViewOnInitDone: nextFitViewOnInitDone });
    if ((changes == null ? void 0 : changes.length) > 0) {
      onNodesChange == null ? void 0 : onNodesChange(changes);
    }
...
var ReactFlowProvider2 = ({ children: children2 }) => {
  const storeRef = (0, import_react6.useRef)(null);
  if (!storeRef.current) {
    storeRef.current = createRFStore2();
  }
  return import_react6.default.createElement(Provider$12, { value: storeRef.current }, children2);
};
ReactFlowProvider2.displayName = "ReactFlowProvider";
var Wrapper2 = ({ children: children2 }) => {
  const isWrapped = (0, import_react6.useContext)(StoreContext2);
  if (isWrapped) {
    return import_react6.default.createElement(import_react6.default.Fragment, null, children2);
  }
  return import_react6.default.createElement(ReactFlowProvider2, null, children2);
};
...
var ReactFlow2 = (0, import_react6.forwardRef)(({ nodes, edges, defaultNodes, defaultEdges, className, nodeTypes = defaultNodeTypes2, edgeTypes = defaultEdgeTypes2, onNodeClick, onEdgeClick, onInit, onMove, onMoveStart, onMoveEnd, onConnect, onConnectStart, onConnectEnd, onClickConnectStart, onClickConnectEnd, onNodeMouseEnter, onNodeMouseMove, onNodeMouseLeave, onNodeContextMenu, onNodeDoubleClick, onNodeDragStart, onNodeDrag, onNodeDragStop, onNodesDelete, onEdgesDelete, onSelectionChange, onSelectionDragStart, onSelectionDrag, onSelectionDragStop, onSelectionContextMenu, onSelectionStart, onSelectionEnd, connectionMode = ConnectionMode2.Strict, connectionLineType = ConnectionLineType2.Bezier, connectionLineStyle, connectionLineComponent, connectionLineContainerStyle, deleteKeyCode = "Backspace", selectionKeyCode = "Shift", selectionOnDrag = false, selectionMode = SelectionMode2.Full, panActivationKeyCode = "Space", multiSelectionKeyCode = isMacOs2() ? "Meta" : "Control", zoomActivationKeyCode = isMacOs2() ? "Meta" : "Control", snapToGrid = false, snapGrid = initSnapGrid2, onlyRenderVisibleElements = false, selectNodesOnDrag = true, nodesDraggable, nodesConnectable, nodesFocusable, nodeOrigin = initNodeOrigin2, edgesFocusable, edgesUpdatable, elementsSelectable, defaultViewport = initDefaultViewport2, minZoom = 0.5, maxZoom = 2, translateExtent = infiniteExtent2, preventScrolling = true, nodeExtent, defaultMarkerColor = "#b1b1b7", zoomOnScroll = true, zoomOnPinch = true, panOnScroll = false, panOnScrollSpeed = 0.5, panOnScrollMode = PanOnScrollMode2.Free, zoomOnDoubleClick = true, panOnDrag = true, onPaneClick, onPaneMouseEnter, onPaneMouseMove, onPaneMouseLeave, onPaneScroll, onPaneContextMenu, children: children2, onEdgeUpdate, onEdgeContextMenu, onEdgeDoubleClick, onEdgeMouseEnter, onEdgeMouseMove, onEdgeMouseLeave, onEdgeUpdateStart, onEdgeUpdateEnd, edgeUpdaterRadius = 10, onNodesChange, onEdgesChange, noDragClassName = "nodrag", noWheelClassName = "nowheel", noPanClassName = "nopan", fitView: fitView3 = false, fitViewOptions, connectOnClick = true, attributionPosition, proOptions, defaultEdgeOptions, elevateNodesOnSelect = true, elevateEdgesOnSelect = false, disableKeyboardA11y = false, autoPanOnConnect = true, autoPanOnNodeDrag = true, connectionRadius = 20, isValidConnection, onError, style: style3, id: id2, nodeDragThreshold, ...rest }, ref) => {
  ...
  return import_react6.default.createElement(
    "div",
    { ...rest, style: { ...style3, ...wrapperStyle2 }, ref, className: cc(["react-flow", className]), "data-testid": "rf__wrapper", id: id2 },
    import_react6.default.createElement(
      Wrapper2,
      null,
...
function NodeToolbarPortal({ children: children2 }) {
  ...
  return (0, import_react_dom3.createPortal)(children2, wrapperRef);
}
var nodeEqualityFn = (a, b) => {
  var _a, _b, _c, _d, _e, _f;
  return ((_a = a == null ? void 0 : a.positionAbsolute) == null ? void 0 : _a.x) === ((_b = b == null ? void 0 : b.positionAbsolute) == null ? void 0 : _b.x) && ((_c = a == null ? void 0 : a.positionAbsolute) == null ? void 0 : _c.y) === ((_d = b == null ? void 0 : b.positionAbsolute) == null ? void 0 : _d.y) && (a == null ? void 0 : a.width) === (b == null ? void 0 : b.width) && (a == null ? void 0 : a.height) === (b == null ? void 0 : b.height) && (a == null ? void 0 : a.selected) === (b == null ? void 0 : b.selected) && ((_e = a == null ? void 0 : a[internalsSymbol2]) == null ? void 0 : _e.z) === ((_f = b == null ? void 0 : b[internalsSymbol2]) == null ? void 0 : _f.z);
};
...
function NodeToolbar({ nodeId, children: children2, className, style: style3, isVisible, position = Position2.Top, offset = 10, align = "center", ...rest }) {
  const contextNodeId = useNodeId2();
  const nodesSelector2 = (0, import_react7.useCallback)((state) => {
  ...
  const { transform: transform2, nodeOrigin, selectedNodesCount } = useStore2(storeSelector, shallow$1);
  const isActive = typeof isVisible === "boolean" ? isVisible : nodes.length === 1 && nodes[0].selected && selectedNodesCount === 1;
  if (!isActive || !nodes.length) {
    return null;
  }
  const nodeRect = getNodesBounds2(nodes, nodeOrigin);
  const zIndex = Math.max(...nodes.map((node) => {
    var _a;
    return (((_a = node[internalsSymbol2]) == null ? void 0 : _a.z) || 1) + 1;
  }));
  const wrapperStyle3 = {
    position: "absolute",
  ...
  return import_react7.default.createElement(
    NodeToolbarPortal,
    null,
    import_react7.default.createElement("div", { style: wrapperStyle3, className: cc(["react-flow__node-toolbar", className]), ...rest }, children2)
  );
}

// node_modules/reactflow/node_modules/@reactflow/node-resizer/dist/esm/index.mjs
...
function ResizeControl({ nodeId, position, variant = ResizeControlVariant.Handle, className, style: style3 = {}, children: children2, color: color2, minWidth = 10, minHeight = 10, maxWidth = Number.MAX_VALUE, maxHeight = Number.MAX_VALUE, keepAspectRatio = false, shouldResize, onResizeStart, onResize, onResizeEnd }) {
  const contextNodeId = useNodeId();
  const id2 = typeof nodeId === "string" ? nodeId : contextNodeId;
  const store = useStoreApi();
  const resizeControlRef = (0, import_react8.useRef)(null);
  const startValues = (0, import_react8.useRef)(initStartValues);
  const prevValues = (0, import_react8.useRef)(initPrevValues);
  const getPointerPosition = useGetPointerPosition();
  ...
  const controlStyle = color2 ? { ...style3, [colorStyleProp]: color2 } : style3;
  return import_react8.default.createElement("div", { className: cc(["react-flow__resize-control", "nodrag", ...positionClassNames, variant, className]), ref: resizeControlRef, style: controlStyle }, children2);
}
var ResizeControl$1 = (0, import_react8.memo)(ResizeControl);
...
function NodeResizer({ nodeId, isVisible = true, handleClassName, handleStyle, lineClassName, lineStyle, color: color2, minWidth = 10, minHeight = 10, maxWidth = Number.MAX_VALUE, maxHeight = Number.MAX_VALUE, keepAspectRatio = false, shouldResize, onResizeStart, onResize, onResizeEnd }) {
  ...
  return import_react8.default.createElement(
    ...
    null,
    lineControls.map((c) => import_react8.default.createElement(ResizeControl$1, { key: c, className: lineClassName, style: lineStyle, nodeId, position: c, variant: ResizeControlVariant.Line, color: color2, minWidth, minHeight, maxWidth, maxHeight, onResizeStart, keepAspectRatio, shouldResize, onResize, onResizeEnd })),
    handleControls.map((c) => import_react8.default.createElement(ResizeControl$1, { key: c, className: handleClassName, style: handleStyle, nodeId, position: c, color: color2, minWidth, minHeight, maxWidth, maxHeight, onResizeStart, keepAspectRatio, shouldResize, onResize, onResizeEnd }))
  );
}
export {
